...
const T = {
  en: {
    ...
    profile:'Profile', displayName:'Display name', language:'Language', privacy:'Privacy', plan:'Plan', free:'Free',
    freePlan:'All features included · unlimited chats and calls · HD video · screen sharing · P2P files up to 1 GB',
    incomingCall:'Incoming call', answer:'Answer', decline:'Decline', hangup:'Hang up',
    ...
    search:'Search contacts', today:'Today', network:'Network', online:'Online', reconnecting:'Reconnecting',
    directOnly:'No owned servers', about:'About', localData:'Chat history, contacts and profile are stored locally in Chrome.',
  ...
  ru: {
    ...
    profile:'Профиль', displayName:'Имя', language:'Язык', privacy:'Приватность', plan:'Тариф', free:'Бесплатно',
    freePlan:'Все функции доступны · безлимитные чаты и звонки · HD-видео · демонстрация экрана · P2P-файлы до 1 ГБ',
    incomingCall:'Входящий звонок', answer:'Ответить', decline:'Отклонить', hangup:'Завершить',
    ...
    invalidInvite:'Некорректное приглашение.',
    ...
    today:'Сегодня', network:'Сеть', online:'Онлайн', reconnecting:'Переподключение',
    directOnly:'Без собственных серверов', about:'О приложении', localData:'История чатов, контакты и профиль хранятся локально в Chrome.',
  ...
  de: {
    ...
    noChats:'Noch keine Unterhaltungen', profile:'Profil', displayName:'Anzeigename', language:'Sprache', privacy:'Datenschutz', plan:'Tarif', free:'Kostenlos',
    freePlan:'Alle Funktionen enthalten · unbegrenzte Chats und Anrufe · HD-Video · Bildschirmfreigabe · P2P-Dateien bis 1 GB',
    incomingCall:'Eingehender Anruf', answer:'Annehmen', decline:'Ablehnen', hangup:'Auflegen', mic:'Mikrofon', camera:'Kamera', shareScreen:'Bildschirm teilen',
    ...
    pasteHelp:'Füge den erhaltenen VeilTalk-Code ein.', save:'Speichern', delete:'Löschen', version:'Version', chromeOpen:'VeilTalk bleibt erreichbar, solange Chrome läuft.',
    invalidInvite:'Ungültige Einladung.', notReady:'Kontakt hat die Kopplung noch nicht abgeschlossen.', fileTooLarge:'Datei überschreitet das Größenlimit.', fileSent:'Datei gesendet', download:'Herunterladen',
    search:'Kontakte suchen', today:'Heute', network:'Netzwerk', online:'Online', reconnecting:'Neu verbinden', directOnly:'Keine eigenen Server',
  ...
  fr: {
    ...
    displayName:'Nom affiché', language:'Langue', privacy:'Confidentialité', plan:'Offre', free:'Gratuit', freePlan:'Toutes les fonctions incluses · chats et appels illimités · vidéo HD · partage d’écran · fichiers P2P jusqu’à 1 Go',
    incomingCall:'Appel entrant', answer:'Répondre', decline:'Refuser', hangup:'Raccrocher', mic:'Micro', camera:'Caméra', shareScreen:'Partager l’écran', directP2P:'Média WebRTC direct',
    ...
    chromeOpen:'VeilTalk reste joignable tant que Chrome fonctionne.', invalidInvite:'Invitation invalide.', notReady:'Le contact n’a pas terminé l’association.',
    fileTooLarge:'Fichier trop volumineux.', fileSent:'Fichier envoyé', download:'Télécharger', search:'Rechercher', today:'Aujourd’hui', network:'Réseau', online:'En ligne', reconnecting:'Reconnexion',
    directOnly:'Sans serveurs propriétaires', about:'À propos', localData:'Historique, contacts et profil stockés localement dans Chrome.', needTurn:'Certains réseaux restrictifs nécessitent TURN; ce MVP utilise seulement STUN public.'
  },
  es: {
    ...
    message:'Mensaje', send:'Enviar', call:'Llamada de voz', video:'Videollamada', attach:'Archivo', noChats:'Aún no hay conversaciones', profile:'Perfil', displayName:'Nombre', language:'Idioma', privacy:'Privacidad', plan:'Plan', free:'Gratis',
    freePlan:'Todas las funciones incluidas · chats y llamadas ilimitados · vídeo HD · compartir pantalla · archivos P2P hasta 1 GB',
    incomingCall:'Llamada entrante', answer:'Responder', decline:'Rechazar', hangup:'Colgar',
    ...
    pasteHelp:'Pega el código VeilTalk recibido.', save:'Guardar', delete:'Eliminar', version:'Versión', chromeOpen:'VeilTalk sigue disponible mientras Chrome esté abierto.',
    ...
    directOnly:'Sin servidores propios', about:'Acerca de', localData:'Historial, contactos y perfil se guardan localmente en Chrome.', needTurn:'Algunas redes restrictivas requieren TURN; este MVP usa solo STUN público.'
  }
};
...
const EXTRA = {
  en: {
    ...
    turnReady:'TURN fallback is enabled for restrictive networks.',
  ...
  ru: {
    ...
    turnReady:'Для строгих сетей включён резервный TURN-канал.',
  ...
  de: {
    ...
    turnReady:'TURN-Fallback ist für restriktive Netzwerke aktiviert.',
  ...
  fr: {
    ...
    turnReady:'Le relais TURN est activé pour les réseaux restrictifs.',
  ...
  es: {
    ...
    turnReady:'El respaldo TURN está activo para redes restrictivas.',
