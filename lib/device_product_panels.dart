...
const String chernogramProductUrl =
    'https://github.com/jeep-jim/chernogram_new/releases';
  ...
  Future<void> _load() async {
    ...
    try {
      final raw = await _channel
          .invokeMapMethod<String, dynamic>('getStorageStats')
...
Future<void> showChernogramProductInfo(
  ...
  PackageInfo? info;
  try {
    info = await PackageInfo.fromPlatform().timeout(const Duration(seconds: 4));
  } catch (_) {
    info = null;
  }
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              info == null
                  ? (ru ? 'Версия недоступна' : 'Version unavailable')
            ...
            Text(
              ru
                  ...
                  : 'Scan the QR code to open Chernogram and download '
                        'the current version.',
